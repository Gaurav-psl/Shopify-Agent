...
(function () {
  ...
  style.textContent = [
    ...
    "#ai-chat-widget-root * { scrollbar-width:thin !important; scrollbar-color:rgba(0,0,0,.2) transparent !important; }",
    "#ai-chat-widget-root *::-webkit-scrollbar { width:5px !important; height:5px !important; background:transparent !important; }",
    "#ai-chat-widget-root *::-webkit-scrollbar-track { background:transparent !important; border:none !important; }",
    "#ai-chat-widget-root *::-webkit-scrollbar-thumb { background:rgba(0,0,0,.2) !important; border-radius:999px !important; border:none !important; }",
    "#ai-chat-widget-root *::-webkit-scrollbar-thumb:hover { background:rgba(0,0,0,.35) !important; }",
    "#ai-chat-widget-root *::-webkit-scrollbar-button { display:none !important; width:0 !important; height:0 !important; }",
    "#ai-chat-widget-root *::-webkit-scrollbar-corner { background:transparent !important; }",
